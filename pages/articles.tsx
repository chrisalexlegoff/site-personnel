...
const TousLesArticles = ({ articlesTab, authorsTab }: articlesTabProps) => {
  const PAGE_SEO: iSEO = {
    title: "Tous les articles",
    description:
      "Page regroupant tous les articles du site personnel de Christophe Le Goff à l'adresse https://christophe-le-goff.fr",
    keywords:
